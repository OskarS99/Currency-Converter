{
  const onFormSubmit = (event) => {
    ...
    if (selectOneElement.value === "PLN" && selectTwoElement.value === "EUR") {
      ...
      selectOneElement.value === "PLN" &&
      selectTwoElement.value === "USD"
    ) {
      let finalAmount = initialAmount * 0.22;
      finalAmountElement.value = finalAmount.toFixed(2);
    } else if (
      selectOneElement.value === "PLN" &&
      selectTwoElement.value === "CHF"
    ) {
      let finalAmount = initialAmount * 0.21;
      finalAmountElement.value = finalAmount.toFixed(2);
    } else if (
      selectOneElement.value === "PLN" &&
      selectTwoElement.value === "GBP"
    ) {
      let finalAmount = initialAmount * 0.19;
      finalAmountElement.value = finalAmount.toFixed(2);
    } else if (
      selectOneElement.value === "EUR" &&
      selectTwoElement.value === "PLN"
    ) {
      ...
      let finalAmount = initialAmount * 0.9;
      finalAmountElement.value = finalAmount.toFixed(2);
    } else if (
      selectOneElement.value === "GBP" &&
      selectTwoElement.value === "PLN"
    ) {
      ...
      let finalAmount = initialAmount * 1.2;
      finalAmountElement.value = finalAmount.toFixed(2);
    }
  };
